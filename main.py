...
print('Welocome to Higher or Lower.')
print(
    'You have to choose wheter the next card to be shown will be higher or lower than the current card.'
)
    ...
    for cardNumber in range(0, N_CARDS):
        ...
        if answer == 'h':
            if nextCardValue > currentCardValue:
                print('You got it right, it was high')
                score = score + 20
            else:
